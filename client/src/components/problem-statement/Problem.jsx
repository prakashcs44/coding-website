  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <h1 className=' text-lg  py-5 leading-10'>
          {problem?.description}
        </h1>
      </div>
      {/* examples*/}
            ...
            problem?.examples&&problem?.examples.map((example, idx) => {
              return (
                <div>
                  ...
                  <div className=' bg-slate-100 my-4 max-h-40 overflow-y-auto px-5 py-3 shadow-md'>
                    <div className='font-semibold '>
                      <h1>Input:</h1>
                      <div className=' py-1 font-normal'>{example?.input} </div>
                    </div>
                    <div className='font-semibold'>
                      <h1>Output:</h1>
                      <div className='py-1 font-normal'>{example?.output}</div>
                    </div>
                    <div className='font-semibold'>
                      <h1>Explanation:</h1>
                      <div className='py-1 font-normal'>{example?.explanation}</div>
                    </div>
                  </div>
                </div>
              )
